  ...
  const UIUX = [
    {
      ...
      description:
        "This Application is designed to solve problem of unavailability of laundry services in Tear-1 and Tear-2 or hostel areas.",
      image:
        "https://res.cloudinary.com/djbe55v48/image/upload/v1773159606/Portfolio/Laundry_App_ylmjrt.png",
      tools: "Figma & many more",
      liveurl:
        "https://www.figma.com/design/IZku0r2VHklQJ6wWlX0XTG/Laundry-Application-UIUX?node-id=0-1&t=RD6K8TC8tpySgI96-1",
    },
  ];
  const projects = [
    {
  ...
  return (
    <Box p={{ base: "2", md: "14", lg: "16" }} w="100%" minH="100vh">
      ...
      <Text
        ...
        color="#58595B"
        fontFamily={"bodytext3"}
        fontSize={{ base: ".95rem", md: "1rem", lg: "1.125rem" }}
      >
      ...
      >
        <Box
          ...
          borderRadius={"full"}
        ></Box>
        <Box mt=".75rem" bgColor="#e45447" w="140px" h="3px"></Box>
      </Center>
      ...
      <Text
        ...
        fontFamily={"bodytext3"}
        fontWeight={"500"}
        fontSize={{ base: "1.25rem", md: "1.35rem", lg: "1.55rem" }}
      >
        Web Applications
      </Text>
            ...
            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer">
              ...
              >
                <Flex w="100%" justifyContent={"space-between"}>
                  ...
                  >
                    {" "}
                    <FaGithub color="#1E88E5" size={"30px"} />
                  </a>
                </Flex>
      ...
      <Center
        borderRadius={"lg"}
        mt={{ base: "4rem", md: "5rem", lg: "6rem" }}
        w={{ base: "100%", md: "55vw", lg: "40vw" }}
        p={{ base: "2rem", md: "2.55rem", lg: "3.25rem" }}
      ...
      >
        ...
        >
          <Center
            transition={"0.3s"}
            bg="rgba(222, 222, 222, 0.36)"
            border="0.5px solid #bcbbbba5"
            _hover={{
          ...
          >
            <Text
              textAlign={"center"}
              color="#222222"
              fontSize={{ base: "1.05rem", md: "1.10rem", lg: "1.125rem" }}
              fontWeight={"600"}
              fontFamily={"bodytext3"}
            >
              My Resume
