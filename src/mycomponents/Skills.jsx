...
function Skills() {
    return (
        <Box p={{ base: "6", md: "14", lg: "16" }} w="100%" minH="100vh" border="1px solid lime">
            ...
            <Flex mt="2.25rem" w="100%" minH="70vh" bg="#F2F0EE">
                <Box p={{ base: "2", md: "3", lg: "5" }} w="100%" h={{ base: "70vh", md: "70vh", lg: "70vh" }} border="1px solid red">
                    {/* Content Box .................... */}


                    <Text textAlign={"center"} mb="0.75rem" color="#58595B" fontFamily={"bodytext3"} fontWeight={"600"} fontSize={"1.125rem"}>BACKEND</Text>
                    <Text lineHeight={"1.5rem"} textAlign={"center"} color="#58595B" fontFamily={"bodytext3"} fontSize={"1rem"}>
                ...
                <Box display={{ base: "none", md: "flex", lg: "flex" }} w="100%" h={{ base: "70vh", md: "70vh", lg: "70vh" }} border="1px solid yellow">
                    {/* Skill Image Box ...................................*/}
                </Box>
